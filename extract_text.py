...
# --- Stream route for OCR typing effect ---
...
def stream_text():
    ...
    def generate():
        for chunk in chunk_text_for_streaming(clean_text):
            yield chunk + " "
